...
#include "AGuiOpenCV/Fun/AGuiOpenCV244.h"
#include "AGuiOpenCV/Fun/AGuiOpenAI.h"
...
public:
	...
	afx_msg void OnImgFlashFadein();
	afx_msg void OnImgFlashLeftTopLine();
	afx_msg void OnImgFlashLeftRight();
	afx_msg void OnImgFlashMidCircle();
	afx_msg void OnImgFlashMidRect();
	afx_msg void OnImgFlashUpDown();
	afx_msg void OnImgFlashUpDownMove();
	afx_msg void OnImgFlashUpLeft();
